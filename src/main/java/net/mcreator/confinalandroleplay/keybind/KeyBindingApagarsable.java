...
public class KeyBindingApagarsable extends ElementsConfinalandRoleplay.ModElement {
	private KeyBinding keys;
	public KeyBindingApagarsable(ElementsConfinalandRoleplay instance) {
		super(instance, 64);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.apagarsable", Keyboard.KEY_LSHIFT, "key.categories.misc");

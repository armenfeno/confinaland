...
public class BlockTest extends ElementsConfinalandRoleplay.ModElement {
	@GameRegistry.ObjectHolder("confinalandroleplay:test")
	public static final Block block = null;
	public BlockTest(ElementsConfinalandRoleplay instance) {
		super(instance, 33);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("confinalandroleplay:test", "inventory"));
	}

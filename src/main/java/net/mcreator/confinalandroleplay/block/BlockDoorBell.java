...
public class BlockDoorBell extends ElementsConfinalandRoleplay.ModElement {
	@GameRegistry.ObjectHolder("confinalandroleplay:doorbell")
	public static final Block block = null;
	public BlockDoorBell(ElementsConfinalandRoleplay instance) {
		super(instance, 39);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("doorbell"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("confinalandroleplay:doorbell", "inventory"));
	}

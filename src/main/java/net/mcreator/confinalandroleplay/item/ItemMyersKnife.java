...
public class ItemMyersKnife extends ElementsConfinalandRoleplay.ModElement {
	@GameRegistry.ObjectHolder("confinalandroleplay:myersknife")
	public static final Item block = null;
	public ItemMyersKnife(ElementsConfinalandRoleplay instance) {
		super(instance, 15);
	}
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
				...
				int z = (int) entity.posZ;
				{
					...
					ProcedureMyersKnifeRightClickedInAir.executeProcedure($_dependencies);
				}
				return retval;
			}

...
public class ItemSawMask extends ElementsConfinalandRoleplay.ModElement {
	...
	public void initElements() {
		ItemArmor.ArmorMaterial enuma = EnumHelper.addArmorMaterial("SAWMASK", "confinalandroleplay:saw_mask_", 25, new int[]{2, 5, 6, 2}, 9,
		...
		elements.items.add(() -> new ItemArmor(enuma, 0, EntityEquipmentSlot.HEAD).setUnlocalizedName("sawmaskhelmet")
				.setRegistryName("sawmaskhelmet").setCreativeTab(CreativeTabs.COMBAT));
	}
